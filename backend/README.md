...
## Project Structure
    ...
    ├── test_creating_an_app99_2  # Django project configurations
...
1. Clone this repo and `cd test_creating_an_app99_2`
...
2. Clone this repo and `cd test_creating_an_app99_2`
